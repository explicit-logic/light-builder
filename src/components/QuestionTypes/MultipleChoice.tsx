...
function MultipleChoice({ question, updateQuestion }: MultipleChoiceProps) {
  ...
  const removeOption = (optionId: string) => {
    ...
    const hasCorrectOption = updatedOptions?.some(option => option.isCorrect);
    if (!hasCorrectOption && updatedOptions && updatedOptions.length > 0) {
                    ...
                    >
                      ...
                      <div className="flex-1 flex items-center space-x-2">
                        <input
                          ...
                          onChange={() => updateCorrectOption(option.id)}
